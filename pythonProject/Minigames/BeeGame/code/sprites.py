...
from Minigames.BeeGame.code.timer import Timer
...
class Bee(Enemy):
    def __init__(self, frames, pos, groups, speed):
        super().__init__(frames, pos, groups)
        self.speed = 50
        self.amplitude = randint(500,6003)
        self.frequency = randint(500,600)
...
class Player(AnimatedSprite):
    ...
    def check_floor(self):
        bottom_rect = pygame.Rect(0, 0, self.rect.width, 2).move(self.rect.midbottom[0] - self.rect.width // 2,self.rect.midbottom[1])
